...
Join meeting
    ...
    CREATE
     */
    @FindBy(xpath = "//html/body/div/div[1]/div[53]/button[1]")
    WebElement CREATE;
    ...
    public void CreateMeetingPublic(String Name) throws InterruptedException {
        CREATE.click();
        Thread.sleep(2000);
        Meeting.click();
    ...
    public void CreateMeetingPrivate(String Name) throws InterruptedException {
        CREATE.click();
        Thread.sleep(2000);
        Meeting.click();
        MeetingNameInput.sendKeys(Name);
    ...
    public void CreateStageMeetingPublic(String Name) throws InterruptedException {
        CREATE.click();
        Thread.sleep(2000);
        Meeting.click();
        MeetingNameInput.sendKeys(Name);
    ...
    public void CreateStageMeetingPrivate(String Name) throws InterruptedException {
        CREATE.click();
        Thread.sleep(2000);
        Meeting.click();
        MeetingNameInput.sendKeys(Name);
    ...
    public void CreateChannelPublic(String Name,String Description) throws InterruptedException {
        CREATE.click();
        Thread.sleep(2000);
        Channel.click();
